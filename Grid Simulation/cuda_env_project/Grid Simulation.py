...
from cuda_square_simulation import SquareSimulation, random_initial_grid, random_action_grid, random_initial_grid_with_gaussians, one_intelligent_population_action_grid, one_intelligent_population_vs_random_action_grid
...
def run_visual_simulation_grid(simulation, interval=500, iterations=100, population_colors=None):
    ...
    def update(frame):
        action_grid = one_intelligent_population_vs_random_action_grid(0, simulation)
...
if __name__ == "__main__":
    ...
    # TODO transforme population as a tensor for arbitrary number of population
