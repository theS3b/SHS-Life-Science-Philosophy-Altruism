...
# --------------------------
def run_visual_simulation_grid(simulation, interval=500, iterations=100, population_colors=None, save_file=None):
    """
    ...
    def update_grid(action_grid=None):
        ...
        if(save_file is not None):
            filename = f"{current_iteration:04d}_{save_file}"
